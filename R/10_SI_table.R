...
note_sup6 <- "Notes. For BPD features, the xiam_date model returned status code 1 (green) and was retained. For further information on OpenMx status codes, see: https://openmx.ssri.psu.edu/wiki/errors"
